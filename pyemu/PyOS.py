    ...
    def add_library(self, dll, function):
        ...
        if hasattr(ctypes, 'windll'):
            if isinstance(dll, str):
                ...
                address = ctypes.windll.kernel32.GetProcAddress(handle, function)
    ...
    class __THREAD(object):
        ...
        class __TEB(object):
            ...
            class __TIB(object):
                ...
                class __EXCEPTION_RECORD(object):
                    '''
                    __EXCEPTION_RECORD:
